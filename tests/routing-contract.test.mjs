...
test("goalkeeper landscape game is exposed as a thinking lab tool", async () => {
  ...
  const gameScriptPath = new URL("../public/tools/goalkeeper-landscape/assets/index-D5TcktdZ.js", import.meta.url);
  ...
  assert.match(goalkeeperRuntime, /index-D5TcktdZ\.js/);
  ...
  assert.match(gameIndex, /\/tools\/goalkeeper-landscape\/assets\/index-D5TcktdZ\.js/);
  ...
  assert.match(gameScriptSource, /match-square-120mm-knotted-net/);
