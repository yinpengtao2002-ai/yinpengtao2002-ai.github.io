...
test("goalkeeper landscape game is exposed as a thinking lab tool", async () => {
  ...
  const gameScriptPath = new URL("../public/tools/goalkeeper-landscape/assets/index-BpRx04yj.js", import.meta.url);
  ...
  assert.match(goalkeeperRuntime, /index-BpRx04yj\.js/);
  ...
  assert.match(gameIndex, /\/tools\/goalkeeper-landscape\/assets\/index-BpRx04yj\.js/);
  ...
  assert.match(gameScriptSource, /match-square-140mm-knotted-net/);
  ...
  assert.doesNotMatch(gameScriptSource, /goal-net-landscape-rear-catenary-cord/);
  assert.doesNotMatch(gameScriptSource, /goal-net-broadcast-rear-mesh-cord/);
  assert.doesNotMatch(gameScriptSource, /goal-net-rear-hex-pocket-thread/);
  ...
  assert.doesNotMatch(gameScriptSource, /goal-net-side-cheek-lace/);
  assert.match(gameScriptSource, /goal-net-cord-highlight/);
  assert.doesNotMatch(gameScriptSource, /goal-net-side-return-cord/);
  assert.doesNotMatch(gameScriptSource, /goal-net-side-depth-cord/);
  assert.match(gameScriptSource, /goal-net-raised-border-rope/);
  assert.match(gameScriptSource, /goal-net-corner-sleeve/);
  assert.doesNotMatch(gameScriptSource, /goal-net-rear-pocket-depth-lace/);
  assert.doesNotMatch(gameScriptSource, /goal-net-rear-pocket-diamond-rope/);
  assert.doesNotMatch(gameScriptSource, /goal-net-raised-vertical-cord/);
