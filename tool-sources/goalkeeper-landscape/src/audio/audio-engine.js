...
const SYNTH_PROFILE = {
  ...
  court: { frequency: 95, endFrequency: 58, duration: 0.11, gain: 0.04, type: "sawtooth" },
...
const AUDIO_EVENT_PLANS = {
  ...
  "court-skid": [
    { name: "court", delay: 0, gainScale: 0.48, layer: MATCHDAY_AUDIO_EVENT_LAYER, marker: "court-skid-audio-cue" },
