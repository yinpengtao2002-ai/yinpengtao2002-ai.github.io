...
export const metadata: Metadata = {
    ...
    description: "上传 CSV 或 Excel 明细数据，使用 Perspective 在网页内完成字段拖拽、分组、筛选、排序、透视表和图表分析。",
};
    ...
    return (
        <section className={className}>
            ...
            <p>
                ...
                直接在网页中拖动字段，切换透视表、柱状图、折线图、热力图和散点图。
            </p>
            <h2>适用场景</h2>
            <ul>
