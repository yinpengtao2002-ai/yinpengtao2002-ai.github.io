...
function ProjectDescription({ className = "" }: { className?: string }) {
    return (
        <section className={className}>
            <h1>预算实际对比模型</h1>
            <p>
                这是一个面向总部经营复盘的财务模型，用实际与预算两套口径聚焦销量、净收入总额、
                单车净收入、边际总额、单车边际和利润总额，并支持按用户上传的维度自主筛选和下钻。
            </p>
            <h2>适用场景</h2>
            <ul>
            ...
            <ul>
                ...
                <li>经营明细用于边际以上分析；固定科目在页面表格中粘贴或手工填写。</li>
            </ul>
            <h2>输出结果</h2>
            <ul>
                <li>销量、净收入总额、单车净收入、边际总额、单车边际、利润总额和预算达成。</li>
                <li>预算到实际边际瀑布图、单车净收入和单车边际矩阵、利润变动桥、利润桥和利润结构桑基图。</li>
                <li>维度经营实绩支持点击柱子、选择明细或使用筛选器逐层下钻归因。</li>
            </ul>
        </section>
    );
}
