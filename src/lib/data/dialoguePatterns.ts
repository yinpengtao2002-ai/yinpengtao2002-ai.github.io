...
export const greetingPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "嗨！想看【财务建模】还是【AI 见闻】？也可以直接问我单车边际分析工具。",
...
export const identityPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "我是 Lucas 网站里的内容助手，负责把【AI 见闻】和【财务建模】里的内容快速带给你。"
        ]
    },
    {
        keywords: ["你能做什么", "你会什么", "你有什么功能", "你的能力"],
        responses: [
            "我可以帮你找本站文章、介绍 Lucas、推荐【财务建模】或【AI 见闻】内容，也能带你打开单车边际分析工具。",
...
export const ownerPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "Lucas 是这个网站的主人。你可以从【财务建模】看他的工具和模型，也可以从【AI 见闻】看他的技术思考。",
            "如果想了解 Lucas，可以先看首页介绍，再看【财务建模】和【AI 见闻】两个板块。"
        ]
    }
];
...
export const technologyPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "如果你关心技术和 AI 工具，可以先看【AI 见闻】板块。",
            "本站有一些 AI 工具应用和内容生产方法的文章，你可以从【AI 见闻】开始。"
        ]
    },
    {
        keywords: ["机器人", "robot", "chatgpt", "gpt", "claude", "openai"],
        responses: [
            "你可以去【AI 见闻】看看 Lucas 对 AI 工具和内容生产的思考。",
            "如果你想看 AI 相关内容，我可以帮你打开【AI 见闻】板块。",
...
export const defaultResponses: string[] = [
    ...
    "这个问题超出本站导览范围了。你可以试试问我【AI 见闻】、【财务建模】或【单车边际变动归因分析】。",
    "我现在主要负责站内内容推荐。想看文章可以问“有什么内容”，想用工具可以问“单车边际分析在哪里”。",
    "我没完全理解你的问题。你可以直接输入“AI 见闻”“财务建模”或“单车边际归因工具”。",
    "如果你想浏览本站，我建议从 [财务建模](/finance) 或 [AI 见闻](/ai) 开始。"
];
