...
export const greetingPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "嗨！想看【财务模型】还是【AI 工作流】？也可以直接问我单车指标归因模型。",
...
export const identityPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "我是 Lucas 网站里的内容助手，负责把【AI 工作流】和【财务模型】里的内容快速带给你。"
        ]
    },
    {
        keywords: ["你能做什么", "你会什么", "你有什么功能", "你的能力"],
        responses: [
            "我可以帮你找本站文章、介绍 Lucas、推荐【财务模型】或【AI 工作流】内容，也能带你打开单车指标归因模型。",
...
export const defaultResponses: string[] = [
    ...
    "这个问题超出本站导览范围了。你可以试试问我【AI 工作流】、【财务模型】或【单车指标变动归因模型】。",
    "我现在主要负责站内内容推荐。想看文章可以问“有什么内容”，想用工具可以问“单车指标归因模型在哪里”。",
    "我没完全理解你的问题。你可以直接输入“AI 工作流”“财务模型”或“单车指标归因模型”。",
    "如果你想浏览本站，我建议从 [财务模型](/finance) 或 [AI 工作流](/ai) 开始。"
];
