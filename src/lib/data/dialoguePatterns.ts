...
export const greetingPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "嗨！想看【财务模型】还是【工具与思考】？也可以直接问我单车指标归因模型。",
...
export const identityPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            ...
            "我是 Lucas 网站里的内容助手，负责把【工具与思考】和【财务模型】里的内容快速带给你。"
        ]
    },
    {
        keywords: ["你能做什么", "你会什么", "你有什么功能", "你的能力"],
        responses: [
            "我可以帮你找本站文章、介绍 Lucas、推荐【财务模型】或【工具与思考】内容，也能带你打开单车指标归因模型。",
...
export const boredomPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "无聊的话，不如去【工具与思考】看看 AI 工具和知识工作方法？",
            "闲着也是闲着，要不我们聊聊天？",
...
export const curiosityPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "这个问题有点深奥呢...🤔 不如去【工具与思考】或【财务建模】找找答案？",
...
export const technologyPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "如果你关心技术和 AI 工具，可以先看【工具与思考】板块。",
            "本站有一些 AI 工具应用和内容生产方法的文章，你可以从【工具与思考】开始。"
        ]
    },
    {
        keywords: ["机器人", "robot", "chatgpt", "gpt", "claude", "openai"],
        responses: [
            "你可以去【工具与思考】看看 Lucas 对 AI 工具和内容生产的思考。",
            "如果你想看 AI 相关内容，我可以帮你打开【工具与思考】板块。",
...
export const randomPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "好的！请选择你想去的板块吧～【工具与思考】还是【财务建模】？",
            "收到！那你想去哪个板块呢？告诉我或者点击上面的按钮都行 👆",
            "明白～请输入'AI'或'财务'，我来带你导航！",
            "了解！那接下来想去【工具与思考】还是【财务建模】？随时告诉我！"
        ]
    },
    {
...
export const defaultResponses: string[] = [
    ...
    "这个问题超出本站导览范围了。你可以试试问我【工具与思考】、【财务模型】或【单车指标变动归因模型】。",
    "我现在主要负责站内内容推荐。想看文章可以问“有什么内容”，想用工具可以问“单车指标归因模型在哪里”。",
    "我没完全理解你的问题。你可以直接输入“工具与思考”“财务模型”或“单车指标归因模型”。",
    "如果你想浏览本站，我建议从 [财务模型](/finance) 或 [工具与思考](/thinking-lab) 开始。"
];
