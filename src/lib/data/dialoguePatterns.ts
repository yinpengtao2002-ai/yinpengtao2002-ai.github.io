...
export const greetingPatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "你好！我可以帮你找本站文章、财务模型，或打开单车边际分析工具。",
            "你好，欢迎来到 Lucas 的个人网站。你可以问我：Lucas 是谁、有哪些文章、财务工具在哪里。",
            "嗨！想看【财务模型】还是【AI 工作流】？也可以直接问我单车边际分析工具。",
...
export const identityPatterns: DialoguePattern[] = [
    ...
    },
    {
        ...
        responses: [
            "我可以帮你找本站文章、介绍 Lucas、推荐【财务模型】或【AI 工作流】内容，也能带你打开单车边际分析工具。",
            "我的核心能力是站内导览：找文章、找工具、解释网站内容入口。",
            "你可以问我：有哪些文章、Lucas 是谁、财务模型在哪里、单车边际归因工具怎么打开。"
        ]
    }
];
...
export const weatherTimePatterns: DialoguePattern[] = [
    {
        ...
        responses: [
            "我不读取实时天气。这里我更适合帮你找本站内容，比如财务模型或单车边际分析工具。",
...
export const defaultResponses: string[] = [
    "我更适合回答本站相关问题。你可以问：Lucas 是谁、有哪些文章、财务模型在哪里、单车边际工具怎么打开。",
    "这个问题超出本站导览范围了。你可以试试问我【AI 工作流】、【财务模型】或【单车边际变动归因分析】。",
    "我现在主要负责站内内容推荐。想看文章可以问“有什么内容”，想用工具可以问“单车边际分析在哪里”。",
    "我没完全理解你的问题。你可以直接输入“AI 工作流”“财务模型”或“单车边际归因工具”。",
